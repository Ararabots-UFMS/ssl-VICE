...
#     [(10, 5, 20, 10), (2, 5, 20, 5), (30, 5, 20, 20), (-10, -5, -7, -5), (-5, -10, -7, -7)],
# )
...
#     [(10, -20, 20), (15, 5, 15), (-20, -30, 30), (2, -2, 2), (-15, 10, 15)],
# )
...
#     assert math.isclose(result[0], expected_vec[0], rel_tol=1e-9) and math.isclose(
#         result[1], expected_vec[1], rel_tol=1e-9
#     )
...
#     ],
# )
# def test_min_diff_vec_and_opposite(
#     num, orientation, vec: Vec2D, goal: Vec2D, expected_boolean, expected_int
# ):
...
#     ],
# )
# def test_get_orientation_and_angle(
#     orientation, robot_vector, goal_vector, do_nothing_angle, expected_bool, expected_theta
# ):
