...
class PIDController():
    def __init__(self, kp: float, ki: float, kd: float):
        ...
        self.output_limit: float = 2    # Max velocity
    ...
    def compute_trajectory_following(self, target_position: float, target_velocity: float, 
                                   current_position: float, current_velocity: float, 
...
class RobotTrajectoryController():
    ...
    def compute_trajectory_command(self, robot_id: int, 
                                 target_state: State,
                                 current_state: State,
                                 dt: Optional[float] = None) -> Vector2D:
        """
