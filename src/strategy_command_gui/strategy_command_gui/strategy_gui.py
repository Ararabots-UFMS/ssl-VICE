...
from system_interfaces.srv import ControlParams, SetKp, SetOrientation, StrategyCommand
...
class StrategyCommandGUI(Node):
    ...
    def setup_strategy_tab(self, notebook):
        ...
        orientation_entry.grid(row=7, column=1, sticky=tk.W, pady=2)
        ...
        orientation_slider.grid(
            row=8, column=0, columnspan=2, sticky=(tk.W, tk.E), pady=(2, 10)
        )
        ...
        preset_frame.grid(row=10, column=0, columnspan=3, pady=10, sticky=(tk.W, tk.E))
        ...
        response_frame.grid(
            row=11, column=0, columnspan=3, pady=10, sticky=(tk.W, tk.E, tk.N, tk.S)
        )
        ...
        strategy_frame.rowconfigure(11, weight=1)
